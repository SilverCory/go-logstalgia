...
(function(){
    ...
    function run(readonly){
        ...
        if (readonly === undefined || readonly === false) {
            ...
            pauseinfo ['418'] = typerequests['418'];
        ...
        if (sumarize) {
            ...
            st += ' HTTP TEAPOT: ' + pad(pauseinfo['418'], 5);
    ...
    Open();
    function Open() {
        socket = new WebSocket("ws://" + window.location.hostname + ":" + window.location.port + "/ws", "log");
   ...
   function receive(evnt) {

        if (evnt.data === undefined || evnt.data === "") return false;

        var robj = JSON.parse(evnt.data);
